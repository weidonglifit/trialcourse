      ...
      if (res === "查無教室預約紀錄。" || !res) {
        ...
        rows.forEach((rowStr) => {
          ...
          if (parts.length === 3) {
            ...
            <div style="font-size:1.1em;font-weight:bold;color:#666;"><span style="font-size:1.1em;">${date}</span>
            <span style="margin-left:10px;color:#333;font-size:0.95em;border:1px solid #F4A7B9;border-radius:8px;padding:3px;">${time}</span></div>
