      ...
      if (res === "查無教室預約紀錄。" || !res) {
        ...
        rows.forEach((rowStr) => {
          ...
          if (parts.length === 3) {
            ...
            <div style="display:flex;align-items:center;font-weight:bold;color:#666;"><div style="width:45px;font-size:1.1em;text-align:right;">${date}</div>
            <div style="width:105px;text-align:center;margin-left:10px;color:#333;font-size:0.95em;border:1px solid #F4A7B9;border-radius:8px;padding:3px 0;">${time}</div></div><div>
